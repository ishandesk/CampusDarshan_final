...
export default function Mini3() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/mini6.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'mini6_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="Canteen & startup center" onPress={handleOpenPhotoSphere} />
