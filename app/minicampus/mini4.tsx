...
export default function Mini3() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/mini4.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'mini4_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="Hostel" onPress={handleOpenPhotoSphere} />
        ...
        <TouchableOpacity onPress={() => router.push('/minicampus/mini3')}>
          ...
          <TouchableOpacity onPress={() => router.push('/minicampus/mini6')}>
            <Image
