...
export default function Mini3() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/mini5.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'mini5_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="OAT" onPress={handleOpenPhotoSphere} />
