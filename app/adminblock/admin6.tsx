...
export default function Mini2() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/admin6.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'admin6_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="fifth floor" onPress={handleOpenPhotoSphere} />
