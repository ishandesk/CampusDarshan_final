...
export default function Mini2() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/admin2.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'admin2_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="Reception(ADMIN)" onPress={handleOpenPhotoSphere} />

        <View style={styles.arrowContainer}>
        <TouchableOpacity onPress={() => router.push('/adminblock/admin3')}>
            <Image
              source={require('../../assets/images/forward.png')}
              style={styles.arrow}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => router.push('/adminblock')}>
            <Image
