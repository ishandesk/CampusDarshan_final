...
export default function Mini2() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/admin5.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'admin5_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="Library" onPress={handleOpenPhotoSphere} />
