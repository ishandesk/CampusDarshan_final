...
export default function Mini2() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/admin4.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'admin4_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="Lab" onPress={handleOpenPhotoSphere} />
