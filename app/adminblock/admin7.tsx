...
export default function Mini2() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/admin7.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'admin7_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="fifth floor(back side)" onPress={handleOpenPhotoSphere} />

        <View style={styles.arrowContainer}>
        <TouchableOpacity onPress={() => router.push('/adminblock/admin8')}>
            <Image
              source={require('../../assets/images/left.png')}
              style={styles.arrow}
            />
          </TouchableOpacity>
        <TouchableOpacity onPress={() => router.push('/adminblock/admin6')}>
            <Image
