...
export default function Mini2() {
  ...
  const handleOpenPhotoSphere = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../../assets/images/admin8.jpg'));
      ...
      const fileUri = FileSystem.cacheDirectory + 'admin8_view.jpg';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="parking" onPress={handleOpenPhotoSphere} />
        ...
        <TouchableOpacity onPress={() => router.push('/adminblock')}>
          ...
          <TouchableOpacity onPress={() => router.push('/adminblock/admin7')}>
            <Image
